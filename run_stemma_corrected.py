#!/usr/bin/env python3
"""
Run stemma analysis with correct prompt + data combination
"""
...
def run_claude_with_prompt_and_data(prompt_file, data_file, output_file):
    """Combine prompt and data, then run Claude."""
    ...
    # Run Claude with the combined input
    cmd = [
        "claude",
        combined_input,
        "-p",
...
def main():
    ...
    for chunk_file in chunk_files:
        ...
        if run_claude_with_prompt_and_data(prompt_file, chunk_file, output_file):
            success_count += 1
